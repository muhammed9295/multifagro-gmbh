...
const Hero = () => {
  ...
  const trustBadges = [
    { icon: Shield, text: t("hero.trustBadges.fullyInsured") },
    { icon: Award, text: t("hero.trustBadges.verifiedPartners") },
    { icon: TrendingUp, text: t("hero.trustBadges.movesPerMonth") },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <form onSubmit={handleQuickQuote} className="bg-background rounded-2xl p-6 lg:p-8 shadow-medium border border-border space-y-4">
              <h3 className="text-lg font-heading font-semibold text-foreground">{t("hero.form.title")}</h3>
              
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="fromPostcode" className="text-sm font-medium flex items-center space-x-2">
                    <MapPin className="h-4 w-4 text-primary" />
                    <span>{t("hero.form.movingFrom")}</span>
                  </Label>
                  <Input
                    id="fromPostcode"
                    type="text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="toPostcode" className="text-sm font-medium flex items-center space-x-2">
                    <MapPin className="h-4 w-4 text-primary" />
                    <span>{t("hero.form.movingTo")}</span>
                  </Label>
                  <Input
                    id="toPostcode"
                    type="text"
          ...
          <div className="relative lg:h-[600px] h-[400px]">
            ...
            <div className="absolute bottom-8 left-8 right-8 grid grid-cols-3 gap-4">
              ...
              <div className="bg-background/95 backdrop-blur-sm rounded-xl p-4 shadow-medium border border-border">
                ...
                <div className="text-xs text-muted-foreground">{t("hero.stats.support")}</div>
              </div>
              <div className="bg-background/95 backdrop-blur-sm rounded-xl p-4 shadow-medium border border-border">
                <div className="text-2xl font-heading font-bold text-primary">5k+</div>
                <div className="text-xs text-muted-foreground">{t("hero.stats.moves")}</div>
              </div>
            </div>
          </div>
        </div>
